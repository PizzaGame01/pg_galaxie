...
public class AlienTrades {
    ...
    static class ItemsForEmeraldsTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ...
            return new MerchantOffer(itemstack, new ItemStack(Items.DIAMOND), this.maxUses, this.xpValue, this.priceMultiplier);
        }
    }
    ...
    static class DyedArmorForEmeraldsTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ItemStack itemstack = new ItemStack(Items.DIAMOND, this.price);
    ...
    static class EnchantedBookForEmeraldsTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ...
            return new MerchantOffer(new ItemStack(Items.DIAMOND, j), new ItemStack(Items.BOOK), itemstack, 12, this.xpValue, 0.2F);
        }
    }
    ...
    static class ItemsForEmeraldsAndItemsTrade implements VillagerTrades.ITrade {
        ...
        @Nullable
        public MerchantOffer getOffer(Entity trader, Random rand) {
            return new MerchantOffer(new ItemStack(Items.DIAMOND, this.emeraldCount), new ItemStack(this.buyingItem.getItem(), this.buyingItemCount), new ItemStack(this.sellingItem.getItem(), this.sellingItemCount), this.maxUses, this.xpValue, this.priceMultiplier);
        }
    }
    static class EnchantedItemForEmeraldsTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ...
            ItemStack itemstack1 = new ItemStack(Items.DIAMOND, j);
    ...
    static class SuspiciousStewForEmeraldTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ...
            return new MerchantOffer(new ItemStack(Items.DIAMOND, 1), itemstack, 12, this.xpValue, this.priceMultiplier);
        }
    }
    ...
    static class EmeraldForVillageTypeItemTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            if (trader instanceof IVillagerDataHolder) {
                ...
                return new MerchantOffer(itemstack, new ItemStack(Items.DIAMOND), this.maxUses, this.xpValue, 0.05F);
            } else {
                return null;
            }
        }
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            if (!(trader.world instanceof ServerWorld)) {
                ...
                if (blockpos != null) {
                    ...
                    return new MerchantOffer(new ItemStack(Items.DIAMOND, this.count), new ItemStack(Items.COMPASS), itemstack, this.maxUses, this.xpValue, 0.2F);
                } else {
                    return null;
                }
            }
    ...
    static class ItemWithPotionForEmeraldsAndItemsTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ItemStack itemstack = new ItemStack(Items.DIAMOND, this.emeraldCount);
