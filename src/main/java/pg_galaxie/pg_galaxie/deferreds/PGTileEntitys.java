...
import pg_galaxie.pg_galaxie.blocks.machine.EnegryCableTileEntity;
...
public class PGTileEntitys {
    ...
    public static final RegistryObject<TileEntityType<?>> CABLE = TILE_ENTITYS.register("cable", () -> TileEntityType.Builder.create(EnegryCableTileEntity::new,PGBlocks.CABLE.get()).build(null));
}
